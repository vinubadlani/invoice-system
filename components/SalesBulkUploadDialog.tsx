...
export default function SalesBulkUploadDialog({ 
  ...
  console.log('SalesBulkUploadDialog - Data available:', {
    ...
    businessId,
    parties: Array.isArray(parties) ? parties.slice(0, 3) : [], // Show first 3 parties for debugging
    items: Array.isArray(items) ? items.slice(0, 3) : [] // Show first 3 items for debugging
  })
