            ...
            >
              {!hideIndicator && (
                <div
                  ...
                  style={
                    {
                      "--color-bg": payload[0].color || payload[0].payload?.fill,
                      "--color-border": payload[0].color || payload[0].payload?.fill,
                    } as React.CSSProperties
                  }
                />
              )}
              ...
              >
                <div className="grid gap-1.5">
                  {tooltipLabel}
                  <span className="text-muted-foreground">
                    {getPayloadConfigFromPayload(config, payload[0], nameKey || payload[0].dataKey || "value")?.label || payload[0].name}
                  </span>
                </div>
                {payload[0].value && (
                  <span className="font-mono font-medium tabular-nums text-foreground">
